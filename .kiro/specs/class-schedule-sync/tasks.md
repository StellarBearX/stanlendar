...
- [ ] 4. Core Subject and Section Management
- [ ] 4.1 Implement Subject CRUD operations
...
- [ ] 4.2 Implement Section management with schedule rules
...
- [ ] 4.3 Implement local event generation from sections
